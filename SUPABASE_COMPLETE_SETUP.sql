-- ============================================
-- SETUP COMPLETO DE BASE DE DATOS PARA BARBERÍA
...
-- Asegurar que las columnas existan en services (por si la tabla ya existía)
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- ============================================
-- 7. POLÍTICAS RLS PARA USER_PROFILES
-- ============================================
