-- ============================================
-- SETUP COMPLETO Y CORREGIDO DE BASE DE DATOS PARA BARBERÍA
...
-- ============================================
-- 3. AGREGAR COLUMNAS SI NO EXISTEN (COMPATIBILIDAD)
-- ============================================
...
-- Esto permite que el usuario se registre y cree su perfil
...
-- 1. Ver todas las tablas: SELECT table_name FROM information_schema.tables WHERE table_schema = 'public';
-- 2. Ver todas las funciones: SELECT routine_name FROM information_schema.routines WHERE routine_schema = 'public';
-- 3. Ver todas las políticas: SELECT tablename, policyname FROM pg_policies WHERE schemaname = 'public';
